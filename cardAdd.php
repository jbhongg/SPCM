...
?>
        ...
        <nav id="nav2">
             <ul>
                ...
                <li><a href="card.php">멤버쉽 카드</a></li>
                <li><a href="shipping.php">배송정보</a></li>
             </ul>
        </nav>
        <section class="basket_form">
            <h2 style="text-align: center; font-size:50px">Membership card ADD</h2>
            
             <form  class="admin_form" method = "post" action = "mem_add.php">
                <div class="form-group">
                    <label class="label_font" >User ID</label><br>
                    <input type="text" class="form-control"  name="UID" id="UID" placeholder="Product ID" required>
                </div>
                <div class="form-group">
