...
?>						
        ...
        <section class="orderlist_form">
            <h2 style="text-align: center; font-size:50px">OrderList</h2>
            <br><br>
            <div class="table-responsive">
            <?php
				$conn = mysqli_connect("localhost", "root", "4321","smartphonecase");
                $sql = "select P_Name, Payment_Method, Purchase_Date, Purchase_Qantity, Use_Point, Total_Price 
                from purchase_list_view 
                ...
                <?php
                    echo "<thead>";
                        echo "<tr style='background-color: rgb(192, 159, 192)'>";
                            echo "<th class='col-sm-2'>Product</th>";
                            echo "<th class='col-sm-2'>Payment Method</th>";
                            echo "<th class='col-sm-2'>Purchase Date</th>";
                            echo "<th class='col-sm-2'>Purchase Qantity</th>";
                            echo "<th class='col-sm-2'>Use Point</th>";
                            echo "<th class='col-sm-2'>Total_Price</th>";
                        echo "</tr>";
                    echo "</thead>";
