...
?>
        ...
        <section class="basket_form">
            <h2 style="text-align: center; font-size:50px">Membership card</h2>
            <div class="col-12" style="text-align: center">
                <ul class="actions">
                    <li><button type="button" class="btn btn-primary" id="add" onclick = "location.href = 'cardAdd.php' ">Add</button></li>
                </ul>
            </div><br><br>
            <div class="table-responsive">
				<?php
							$conn = mysqli_connect("localhost", "root", "4321","smartphonecase");
							$sql = "SELECT Mem_ID,U_ID, Point, Issued_Date, Validity FROM membership_card where U_ID='".$_SESSION['userid']."'";
				...
				<?php
                        ...
                        echo "<th class='col-sm-3'>Card Number</th>";
                        echo "<th class='col-sm-3'>User ID</th>";
                        echo "<th class='col-sm-2'>Point</th>";
                        echo "<th class='col-sm-2'>Issued Date</th>";
                        echo "<th class='col-sm-2'>Validity</th>";
                        echo "</tr>";
                        echo "</thead>";
