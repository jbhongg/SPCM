...
?>
        ...
        <section class="case_form">
            <h2 style="text-align: center; font-size:50px ">hard Case</h2>
            <br><br>
            ...
            $sqlCount = "SELECT count(*) FROM product where Type='hard'";
            ...
            $sql = "SELECT * FROM product where Type='hard' limit ".$begin.",".$rowPerPage."";
       ...
       <?php
            ...
            if($currentPage > 1 ) { 
                //이전 버튼이 클릭될때 GET방식으로 currentPage변수 값에 1을 뺀 값이 넘어가도록 함
                    echo "<a class='btn btn-primary' href ='/hard.php?currentPage=1'>&lt;&lt;</a>&nbsp;&nbsp;&nbsp;&nbsp;";

                      echo "<a class='btn btn-primary' href ='/hard.php?currentPage=".($currentPage-1)."'>&lt;</a>&nbsp;&nbsp;&nbsp;&nbsp;";
            }
            ...
            if($currentPage >= 1){
                echo "<a href ='/hard.php?currentPage=".($currentPage)."'>$currentPage</a>&nbsp;&nbsp;&nbsp;&nbsp;";
                echo "<span>/<span>";
                $real_lastPage = ceil($lastPage);
                echo "<a href ='/hard.php?currentPage=".($real_lastPage)."'>$real_lastPage</a>&nbsp;&nbsp;&nbsp;&nbsp;";
            ...
            if($currentPage < $lastPage) { 
                ...
                echo "<a class='btn btn-primary' href ='/hard.php?currentPage=".($real_lastPage)."'>&gt;&gt;</a>";
