...
<head>
	...
	<?php
        ...
        function Login() {
			...
			var Spw = '<?php echo $_SESSION["userpw"];?>';
			
			if(pw == Spw){
				window.open('change_info.php', '_self');
			}
			else{
				document.getElementById('check').innerHTML = '<br>' + "password is incorrect.";
			}
		}
    </script>
</head>
        ...
        <section class="join_form">
            ...
            <form>
                <div class="form-group">
                    <label class="label_font">Password</label>
                ...
                <div class="col-12" style="text-align: center">
                    <ul class="actions">
                        <li><button type="button" class="btn btn-primary" onclick="Login()">check</button>
                        </li>
                        <p id="check"></p>
