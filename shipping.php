...
?>
        ...
        <section class="basket_form">
            <h2 style="text-align: center; font-size:50px">Shipping Information</h2>
            <br><br>
            <div class="table-responsive">
            <?php
							$conn = mysqli_connect("localhost", "root", "4321","smartphonecase");
							$sql = "select P_Name, Ship_Name, Shipping_Status, Expected_Arrival_Date from shipping_view where U_ID='".$_SESSION['userid']."'";
			...
			?>
                ...
                <?php
                    ...
                    echo "<th class='col-sm-3'>Product</th>";
                    echo "<th class='col-sm-2'>Shipper</th>";
                    echo "<th class='col-sm-2'>Shipping Status</th>";
                    echo "<th class='col-sm-3'>Expected Arrival Date</th>";
                    echo "</tr>";
                    echo "</thead>";
                ...
                <tr>
                    ...
                    <td class = "col-sm-3">
                        <?php
                            echo $row["Expected_Arrival_Date"];
                        ?>
                    </td>
                </tr>
                <?php
